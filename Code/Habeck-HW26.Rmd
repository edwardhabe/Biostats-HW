...
Importing data. stringsAsFactors will be applied during this step. 
...
Histogram to check for outliers. It appears that there may be one at approximately 120 ppm, whih could throw off data to some degree. 
...
Zinc <- soil[c(1, 10)]
```
Checking for outliers. There may be one at approximately 22 ppm, considering how far it is from most other points. ]
...
This test determines that there is a significant difference in zinc content between forest location. 